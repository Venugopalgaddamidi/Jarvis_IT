...
function AppContent() {
  ...
  return <>
    ...
    <main className="container">
      {message && <div className="message" style={{}} role="status">{message}<button onClick={() => setMessage('')}>×</button></div>}
      {page === 'auth'
    ...
    <footer className="footer">Jarvis · Keep learning, one course at a time.</footer>
  </>;
}
